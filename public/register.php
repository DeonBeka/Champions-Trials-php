...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->fetch()) {
            ...
            $stmt = $pdo->prepare('INSERT INTO users (email,password,user_type,name,interests,skills,bio,location) VALUES (?,?,?,?,?,?,?,?)');
...
<form method="post" class="form">
  ...
  <label>Interests (comma separated)<input name="interests" type="text"></label>
  <label>Skills (comma separated)<input name="skills" type="text"></label>
